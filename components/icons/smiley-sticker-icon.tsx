export function SmileySticker() {
  return (
    <div style={{ position: "absolute", left: "3.9%", bottom: "6%", transform: "rotate(-6deg)", zIndex: 2 }}>
      <svg style={{ width: 40, height: 40 }} viewBox="0 0 56 56">
        ...
        <path d="M18 32 Q28 42 38 32" fill="none" stroke="var(--ink)" strokeWidth="2.5" strokeLinecap="round" />
      </svg>
    </div>
  );
}
